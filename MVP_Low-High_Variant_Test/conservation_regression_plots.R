...
# Evo2 7b-arc-longcontext delta score, run separately for each of three
# context window sizes: 8,192 bp / 16,384 bp / 65,536 bp.
#
# For each context window, produces the same set of plots as before (filenames
# suffixed with e.g. "_16384bp"), including:
#   1. conservation_individual_regressions_<bp>bp.png — 2x2 violin panel (individual models)
#   2. conservation_joint_regression_forest_<bp>bp.png — forest plot (joint model)
#   ...and the rest of the correlation / VIF / MAF plots described below.
# ============================================================================
...
conservation_raw <- read_csv(conservation_file, show_col_types = FALSE) %>%
...
run_context_analysis <- function(evo2_file, context_bp, conservation, output_dir) {
  ...
  pairs_def <- list(
    ...
    list(x = "phastCons100way",  y = "evo2_delta_score",  x_lab = "phastCons (100-way vertebrate)", y_lab = evo2_model_label, pair_type = "Conservation vs Evo2"),
    list(x = "phyloP100way",     y = "evo2_delta_score",  x_lab = "phyloP (100-way vertebrate)",    y_lab = evo2_model_label, pair_type = "Conservation vs Evo2"),
    list(x = "GERP_RS",          y = "evo2_delta_score",  x_lab = "GERP++ RS",                      y_lab = evo2_model_label, pair_type = "Conservation vs Evo2")
  )
...
# ============================================================================
# Produces the same set of seven plots for each of the 8,192 / 16,384 /
# 65,536 bp context windows, distinguished by a "_<context>bp" filename
# suffix (e.g. conservation_individual_regressions_65536bp.png).
