...
def extract_variants_from_directory(vcf_directory: str, output_file: str = "variants.tsv"):
    """Extract variants from all VCF files in a directory."""
            ...
            with file_handle as f:
                for line in f:
                    ...
                    if len(columns) >= 5:
                        ...
                        alt_alleles = columns[4].split(',')  # Handle multiple alternates
                        
                        # Write each alternate allele as separate variant
